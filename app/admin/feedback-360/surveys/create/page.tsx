...
export default function CreateSurveyPage() {
  ...
  const saveSurvey = async () => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/feedback-surveys`, {
        method: 'POST',
        headers: {
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold">Create Feedback Survey</h1>
          <p className="text-gray-600 mt-2">Design your feedback form with custom questions</p>
        </div>
