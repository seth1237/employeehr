...
const userSchema = new Schema<IUser>(
  {
    ...
    role: {
      type: String,
      enum: ["super_admin", "company_admin", "admin", "manager", "employee", "hr", "sales_rep", "technical_service_engineer", "dispatch"],
      default: "employee",
    },
    ...
    employmentType: {
      type: String,
      enum: ["permanent", "contract", "intern", "casual", "consultant"],
    },
    grade: { type: String },
